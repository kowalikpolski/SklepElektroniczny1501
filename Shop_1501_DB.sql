create table produkt (id int primary key,nazwa varchar(30) not null,model varchar(30) not null,opis varchar(100),ilosc_dostepna int not null,cena money not null,unique(nazwa,model))
